      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            _SettingItem(icon: Icons.volume_up, title: 'TTS 음성', subtitle: 'pt-PT (시스템 보이스)'),
            _SettingItem(icon: Icons.public, title: '변종', subtitle: '유럽 포르투갈어 (Portugal)'),
            _SettingItem(icon: Icons.palette, title: '테마', subtitle: '낮 · verde e vermelho #046A38'),
          ]),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: '저작권', subtitle: '포르투갈어유니버스 · 2026'),
          ]),
