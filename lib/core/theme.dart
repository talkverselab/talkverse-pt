...
/// Portugal 컬러 팔레트 — 국기 verde·vermelho + 석회벽 백색·올리브·청색
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFF046A38);
  static const Color rojoDeep = Color(0xFF03502A);
  static const Color rojoLight = Color(0xFF2F8F5B);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFFDA291C);
  static const Color gualdaBright = Color(0xFFE85A4F);
  static const Color gualdaDeep = Color(0xFFA31E15);
