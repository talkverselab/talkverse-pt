...
## 런처 아이콘
- `assets/icon/icon.png`·`icon_foreground.png` — 언어 상징 글자 `Ã` + 국기 팔레트(PIL 생성). 17개 talkverse 앱 모두 다른 모양이어야 한다는 규칙.
...
## 이 앱 고유 설정
- 팔레트: rojo=046A38(verde) gualda=DA291C(vermelho)
- TTS: pt-PT
